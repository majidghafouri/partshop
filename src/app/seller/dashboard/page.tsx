...
const stats = [
  { label: "فروش کل", value: "۱۲,۵۰۰,۰۰۰", icon: DollarSign, color: "text-primary" },
  { label: "سفارشات", value: "۴۵", icon: ShoppingBag, color: "text-accent" },
  { label: "محصولات فعال", value: "۲۸", icon: Package, color: "text-success" },
  { label: "امتیاز فروشگاه", value: "۴.۸", icon: Star, color: "text-warning" },
];

const recentOrders = [
  { id: "ORD-1234", customer: "علی محمدی", product: "لنت ترمز جلو پراید", price: 1245000, status: "شده", date: "۱۴۰۵/۰۶/۰۸" },
  { id: "ORD-1235", customer: "رضا حسینی", product: "باتری صبا ۶۰ آمپر", price: 4174000, status: "در حال ارسال", date: "۱۴۰۵/۰۶/۰۷" },
  { id: "ORD-1236", customer: "مریم احمدی", product: "فیلتر روغن پراید", price: 320000, status: "جدید", date: "۱۴۰۵/۰۶/۰۸" },
];
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted">فروشگاه قطعات یدکی پارسیان</p>
          </div>
        </div>
        <Link
      ...
      {activeTab === "products" && (
        <div className="bg-surface rounded-2xl border border-border">
          <div className="p-5 border-b border-border flex items-center justify-between">
            ...
            <span className="text-xs text-muted">۲۸ محصول</span>
          </div>
          <div className="divide-y divide-border">
            {products.slice(0, 6).map((product) => (
              <div key={product.id} className="p-4 flex items-center gap-4 hover:bg-surface-hover transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted">{product.category.name} • موجودی: {product.stock}</div>
                </div>
        ...
        <div className="bg-surface rounded-2xl border border-border p-6 max-w-2xl">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                defaultValue="قطعات یدکی پارسیان"
            ...
            <div>
              ...
              <textarea
                defaultValue="فروش انواع لوازم یدکی خودروهای ایرانی و خارجی با بیش از ۱۰ سال سابقه"
